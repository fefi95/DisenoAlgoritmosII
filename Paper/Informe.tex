...
% \csvreader[respect all, autotabular]{grade.csv}{}{\csvlinetotablerow}%
...
\section{Resultados}
*Inserte Resultados*\\
\csvreader[autotabular]{statistics/iris/relief.csv}{}{\csvlinetotablerow}%
\\
\csvreader[autotabular]{statistics/sonar/relief.csv}{}{\csvlinetotablerow}%
\\
\csvreader[autotabular]{statistics/spambase/relief.csv}{}{\csvlinetotablerow}%
\\
\csvreader[autotabular]{statistics/wdbc/relief.csv}{}{\csvlinetotablerow}%
